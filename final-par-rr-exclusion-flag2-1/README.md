# Retained MFCL outputs: RR exclusion (`tag_reporting_flag2=1`)

This directory contains 46 exact retained native MFCL model triplets in the
...
`SHA256SUMS` covers the 46 PARs, 46 matching INIs and 46 matching
REPs. The complete
