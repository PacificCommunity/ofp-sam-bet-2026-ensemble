...
Diagnostic Job 21641 (`S0.90-F2`). Do not run it in place; the ensemble runner
...
and applies no seed, jitter or fitted checkpoint. It retains Job 21641 F2
...
configuration while keeping F2 selectivity fixed. The fitted output is
...
provenance are updated to the Job 21641 tau=2/F2 diagnostic.
